              ...
              <div class="mdl-card__supporting-text mdl-color-text--grey-600">
                ...
                <form action="">
                	...
                	<div class="mdl-textfield mdl-js-textfield">
						 <input class="mdl-textfield__input" name="rental.period.startDate" type="text" id="startDate">
						 <label class="mdl-textfield__label" for="startDate">Start Date</label>
					</div>
                	
                	<div class="mdl-textfield mdl-js-textfield">
						 <input class="mdl-textfield__input"  name="rental.period.endDate" type="text" id="endDate">
